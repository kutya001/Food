...
export const INITIAL_SEED_DATA = {
  ...
  ingredients: [
    { id: 'ing_1', estId: 'est_1', name: 'Говядина мякоть (халяль)', category: 'Мясо', unit: 'кг', purchasePrice: 620, calories: 250, protein: 26, fat: 15, carbs: 0, allergens: [], currentStock: 45.5, stockQty: 45.5, minStockAlert: 10, minStockQty: 10 },
    { id: 'ing_2', estId: 'est_1', name: 'Рис Лазер (узбекский)', category: 'Крупы', unit: 'кг', purchasePrice: 160, calories: 360, protein: 7, fat: 1, carbs: 78, allergens: [], currentStock: 80.0, stockQty: 80.0, minStockAlert: 20, minStockQty: 20 },
    { id: 'ing_3', estId: 'est_1', name: 'Морковь жёлтая', category: 'Овощи', unit: 'кг', purchasePrice: 45, calories: 35, protein: 1.3, fat: 0.1, carbs: 7, allergens: [], currentStock: 60.0, stockQty: 60.0, minStockAlert: 15, minStockQty: 15 },
    { id: 'ing_4', estId: 'est_1', name: 'Лук репчатый', category: 'Овощи', unit: 'кг', purchasePrice: 30, calories: 41, protein: 1.4, fat: 0.2, carbs: 8.2, allergens: [], currentStock: 55.0, stockQty: 55.0, minStockAlert: 10, minStockQty: 10 },
    { id: 'ing_5', estId: 'est_1', name: 'Масло хлопковое рафинированное', category: 'Масла', unit: 'л', purchasePrice: 190, calories: 899, protein: 0, fat: 99.9, carbs: 0, allergens: [], currentStock: 35.0, stockQty: 35.0, minStockAlert: 8, minStockQty: 8 },
    { id: 'ing_6', estId: 'est_1', name: 'Нут отборный', category: 'Бобовые', unit: 'кг', purchasePrice: 180, calories: 364, protein: 19, fat: 6, carbs: 61, allergens: [], currentStock: 25.0, stockQty: 25.0, minStockAlert: 5, minStockQty: 5 },
    { id: 'ing_7', estId: 'est_1', name: 'Зира таджикская ароматная', category: 'Специи', unit: 'кг', purchasePrice: 850, calories: 375, protein: 18, fat: 22, carbs: 44, allergens: [], currentStock: 4.5, stockQty: 4.5, minStockAlert: 1, minStockQty: 1 },
    { id: 'ing_8', estId: 'est_1', name: 'Куриное филе охлаждённое', category: 'Птица', unit: 'кг', purchasePrice: 380, calories: 165, protein: 31, fat: 3.6, carbs: 0, allergens: [], currentStock: 32.0, stockQty: 32.0, minStockAlert: 10, minStockQty: 10 },
    { id: 'ing_9', estId: 'est_1', name: 'Мука пшеничная высший сорт', category: 'Бакалея', unit: 'кг', purchasePrice: 65, calories: 334, protein: 10.3, fat: 1.1, carbs: 68.9, allergens: ['Глютен'], currentStock: 120.0, stockQty: 120.0, minStockAlert: 30, minStockQty: 30 },
    { id: 'ing_10', estId: 'est_1', name: 'Свекла свежая', category: 'Овощи', unit: 'кг', purchasePrice: 40, calories: 43, protein: 1.5, fat: 0.1, carbs: 8.8, allergens: [], currentStock: 40.0, stockQty: 40.0, minStockAlert: 10, minStockQty: 10 },
    { id: 'ing_11', estId: 'est_1', name: 'Капуста белокочанная', category: 'Овощи', unit: 'кг', purchasePrice: 35, calories: 25, protein: 1.8, fat: 0.1, carbs: 4.7, allergens: [], currentStock: 50.0, stockQty: 50.0, minStockAlert: 15, minStockQty: 15 },
    { id: 'ing_12', estId: 'est_1', name: 'Картофель фермерский', category: 'Овощи', unit: 'кг', purchasePrice: 38, calories: 77, protein: 2, fat: 0.4, carbs: 16.3, allergens: [], currentStock: 140.0, stockQty: 140.0, minStockAlert: 25, minStockQty: 25 },
    { id: 'ing_13', estId: 'est_1', name: 'Томатная паста 25%', category: 'Бакалея', unit: 'кг', purchasePrice: 210, calories: 82, protein: 4.8, fat: 0.5, carbs: 15.8, allergens: [], currentStock: 18.0, stockQty: 18.0, minStockAlert: 5, minStockQty: 5 },
    { id: 'ing_14', estId: 'est_1', name: 'Помидоры сочные Южные', category: 'Овощи', unit: 'кг', purchasePrice: 120, calories: 20, protein: 1.1, fat: 0.2, carbs: 3.7, allergens: [], currentStock: 30.0, stockQty: 30.0, minStockAlert: 8, minStockQty: 8 },
    { id: 'ing_15', estId: 'est_1', name: 'Огурцы грунтовые', category: 'Овощи', unit: 'кг', purchasePrice: 90, calories: 15, protein: 0.8, fat: 0.1, carbs: 2.8, allergens: [], currentStock: 25.0, stockQty: 25.0, minStockAlert: 6, minStockQty: 6 },
    { id: 'ing_16', estId: 'est_1', name: 'Зелень свежая (кинза, укроп)', category: 'Зелень', unit: 'кг', purchasePrice: 220, calories: 38, protein: 2.5, fat: 0.5, carbs: 5.2, allergens: [], currentStock: 8.0, stockQty: 8.0, minStockAlert: 2, minStockQty: 2 },
    { id: 'ing_17', estId: 'est_1', name: 'Яйцо куриное С0', category: 'Яйца', unit: 'шт', purchasePrice: 11, calories: 74, protein: 6.3, fat: 5.2, carbs: 0.4, allergens: ['Яйца'], currentStock: 360, stockQty: 360, minStockAlert: 60, minStockQty: 60 },
    { id: 'ing_18', estId: 'est_1', name: 'Сметана 20%', category: 'Молочные', unit: 'кг', purchasePrice: 240, calories: 206, protein: 2.8, fat: 20, carbs: 3.2, allergens: ['Лактоза'], currentStock: 15.0, stockQty: 15.0, minStockAlert: 4, minStockQty: 4 },
    { id: 'ing_19', estId: 'est_2', name: 'Булочки бриошь для бургеров', category: 'Хлеб', unit: 'шт', purchasePrice: 26, calories: 185, protein: 5.5, fat: 4.8, carbs: 29.5, allergens: ['Глютен', 'Лактоза'], currentStock: 85, stockQty: 85, minStockAlert: 20, minStockQty: 20 },
    { id: 'ing_20', estId: 'est_2', name: 'Сыр Чеддер слайсы', category: 'Сыр', unit: 'кг', purchasePrice: 680, calories: 402, protein: 25, fat: 33, carbs: 1.3, allergens: ['Лактоза'], currentStock: 12.0, stockQty: 12.0, minStockAlert: 3, minStockQty: 3 },
    { id: 'ing_21', estId: 'est_2', name: 'Соус барбекю крафтовый', category: 'Соусы', unit: 'л', purchasePrice: 260, calories: 140, protein: 1.2, fat: 0.5, carbs: 32, allergens: [], currentStock: 10.0, stockQty: 10.0, minStockAlert: 2, minStockQty: 2 },
    { id: 'ing_22', estId: 'est_3', name: 'Стейк Рибай мраморная говядина', category: 'Мясо Premium', unit: 'кг', purchasePrice: 1450, calories: 290, protein: 24, fat: 21, carbs: 0, allergens: [], currentStock: 18.5, stockQty: 18.5, minStockAlert: 5, minStockQty: 5 },
    { id: 'ing_23', estId: 'est_3', name: 'Креветки тигровые 16/20', category: 'Морепродукты', unit: 'кг', purchasePrice: 1100, calories: 95, protein: 21, fat: 1.2, carbs: 0.5, allergens: ['Морепродукты'], currentStock: 14.0, stockQty: 14.0, minStockAlert: 4, minStockQty: 4 },
    { id: 'ing_24', estId: 'est_3', name: 'Сливки кулинарные 33%', category: 'Молочные', unit: 'л', purchasePrice: 340, calories: 314, protein: 2.5, fat: 33, carbs: 4.0, allergens: ['Лактоза'], currentStock: 16.0, stockQty: 16.0, minStockAlert: 4, minStockQty: 4 }
  ],
